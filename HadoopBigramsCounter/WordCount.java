  ...
  public static class TokenizerMapper extends Mapper<Object, Text, Text, Text> {
    ...
    public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
      ...
      while (itr.hasMoreTokens()) {
        ...
        word.set(prev + " " + thisword);
        String compareword = prev + " " + thisword;
        if (compareword.equals("computer science") ||
            compareword.equals("information retrieval") ||
            compareword.equals("power politics") ||
            compareword.equals("los angeles") ||
            compareword.equals("bruce willis")) {
          context.write(new Text(compareword), document_Id);
        }
        prev = thisword;
      }
    }
